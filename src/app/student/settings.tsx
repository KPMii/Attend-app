  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.subtitle}>Security and account preferences</Text>
          ...
          {!showDeleteConfirm ? (
            ...
            <View style={{ gap: 8 }}>
              <Text style={styles.confirmText}>
                This permanently deletes your account and all your attendance
        ...
        <View style={styles.card}>
          <Text style={styles.placeholderText}>
            Attendance history export, notifications, and profile photo support
            are on the roadmap.
          </Text>
        </View>
